				...
				<form action="form_pr.php" class="form-horizontal" method="post" id="pop_form" name="form">
					...
					<div id="up_form_box"><!-- div up_form_box start !-->
						<div id="left" style="float:left;width:400px;"> <!-- div left start !-->
							...
							<input id="phone" name="phone" style="width:200px" class="form-control" type="text" />
							<br />
							<?  } if( $ch_sex == 'y'){ ?><!-- 성별 --> 
						...
						<div id="right" style="float:left;width:400px;"><!-- div left start!-->
							...
							<input id="email" name="email" style="width:200px" class="form-control" type="text" />
							<br />
							<?}if( $ch_branch == 'y'){ ?><!-- 지점 --> 
							<label style="width:150px;" for="branch" class="col-lg-2 control-label">
								지점 :
							</label>
							<select style="width:200px" class="form-control"  name="branch">
							...
							<input id="r_date" name="r_date" style="width:200px" class="form-control" type="text" /> 
							<br />
							<?  } if( $ch_group== 'y'){ ?> <!-- 진료 과목 --> 
							<label style="width:150px;" for="sex" class="col-lg-2 control-label">
								진료과목 :
							...
							<select style="width:200px" class="form-control"  name="j_category"> 
								<?
